// Code for updating the experiment progress bars.
function updateProgressBars(continueAction, finishedAction) {
	var task = document.getElementById('taskProgress');		// this particular task progress
	var study = document.getElementById("studyProgress");	// overall study progress
